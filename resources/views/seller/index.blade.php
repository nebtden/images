...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset("/packages/admin/AdminLTE/dist/css/skins/" . config('seller.skin') .".min.css") }}">
...
<body class="hold-transition {{config('seller.skin')}} skin-color {{join(' ', config('admin.layout'))}}">
<div class="wrapper">
